package com.metallica.trade.dao.impl;
...
public class TradeImpl {
	...
	public String getTrades(SearchCriteria searchCriteria) {
		...
		if (searchCriteria.getFromtradeDate() != null && searchCriteria.getTotradeDate() != null) {
			...
			criteria = criteria.andOperator(Criteria.where("tradeDate").gte(searchCriteria.getFromtradeDate()),
					Criteria.where("tradeDate").lte(searchCriteria.getTotradeDate()));

		} else if (searchCriteria.getFromtradeDate() != null && searchCriteria.getTotradeDate() == null) {
			criteria = criteria.and("tradeDate").gte(searchCriteria.getFromtradeDate());

		}

		else if (searchCriteria.getFromtradeDate() == null && searchCriteria.getTotradeDate() != null) {

			criteria = criteria.and("tradeDate").gte(searchCriteria.getTotradeDate());
	...
	public Trade updatetrade(Trade trade) {
		...
		/*///Code for only some field to update 
		 * Query query = new
